...
public class OpenAPIConfig {
    ...
    public GroupedOpenApi publicApi() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("com.bookticket.payment_service")
                .pathsToMatch("/api/**")
                .build();
    }
    ...
    private Info apiInfo() {
        return new Info()
                ...
                .description("""
                        <h2>Payment Service API Documentation</h2>
                        <p>This service handles payment processing, transaction status, and integration with Stripe.</p>
                        """)
                .version("1.0")
                .contact(new Contact()
